<aside id="leftsidebar" class="sidebar">
            ...
            @if (auth()->user()->role == 'admin')
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        ...
                        <li>
                            <a href="{{ Route('form') }}">Manage Employees</a>
                        </li>
                        <li>
                            <a href="pages/tables/editable-table.html">Reports</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="ml-menu">
                        ...
                        <li>
                            <a href="pages/tables/editable-table.html">Report</a>
                        </li>
                    </ul>
                </li>
                <li>
    ...
    <div class="legal">
        <div class="copyright">
            &copy; 2021 | <a href="javascript:void(0);">Construction Management System</a>.
        </div>
        <div class="version">
