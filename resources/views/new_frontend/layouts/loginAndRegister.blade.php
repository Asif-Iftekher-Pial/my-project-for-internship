                        ...
                        <div class="control-group">
                            <div class="controls">
                                <button type="submit" class="btn">Sign in</button> <a
                                    href="{{ route('submitpage') }}">Forget password?</a>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="well">
                    ...
                    <form action="{{ route('user_registration') }}" method="POST">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="span3" type="text" id="inputEmail0" name="name" placeholder="User Name"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="span3" type="Password" name="password" minlength="6" placeholder="Password"
                                    required>
                            </div>
                        </div>
